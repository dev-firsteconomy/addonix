                        ...
                        <div id="useradd-3" class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="float-end">
                                            <a href="#" data-size="md" data-url="<?php echo e(route('task.create')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\addonix\resources\views/user/edit.blade.php ENDPATH**/ ?>