                                    ...
                                    <td class="Permission mt-10">
                                        <div class="badges">
                                            <?php for($j=0;$j<count($role->permissions()->pluck('name'));$j++): ?>
                                                <span class="badge bg-primary p-1 px-2 rounded "><?php echo e($role->permissions()->pluck('name')[$j]); ?></span>
                                            <?php endfor; ?>
                                        </div>
                                    </td>
                                    <?php if(Gate::check('Edit Role') || Gate::check('Delete Role')): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\addonix\resources\views/role/index.blade.php ENDPATH**/ ?>