...
<body class="<?php echo e($color); ?>">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-light me-2"><i
                                class="far fa-eye me-2"></i>Live Demo</a>
                        <a href="https://codecanyon.net/item/salesy-saas-business-sales-crm/30241292"
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            <div class="mt-5">
                <img src="<?php echo e(asset('assets/images/front/salesy-pic-1.png')); ?>" alt=""
        ...
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                <div class="col-sm-4">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="#" class="btn btn-primary"><i class="fas fa-shopping-cart me-2"></i>Buy
                            now</a>
                    </div>
                </div>
                <div class="col-sm-6">
                    <img src="<?php echo e(asset('assets/images/front/salesy-pic-1.png')); ?>" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
    ...
    <section id="feature" class="feature">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-9 title">
                    <h2>
                        <span class="d-block mb-3">Features</span> Business Sales CRM
          ...
          ">
            ...
            <div class="text-center pt-sm-5 feature-mobile-screen">
                <button href="#" class="btn px-sm-5 btn-primary me-sm-3">Buy Now</button>
    ...
    <section id="price" class="price-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-9 title">
                    <h2>
                        <span class="d-block mb-3">Price</span> Business Sales CRM
          ...
          ">
                        <div class="card-body">
                            ...
                            <p class="mb-0">
                                You have Free lifetime Updates and <br />
                ...
                <div class="col-xl-9 col-lg-6 col-md-12 col-sm-12">
                    <div class="row feature-img-row m-auto">
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('assets/images/front/salesy-pic-1.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('assets/images/front/salesy-pic-8.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.4s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('assets/images/front/salesy-pic-14.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.6s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('assets/images/front/salesy-pic-13.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.8s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('assets/images/front/salesy-pic-16.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.3s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('assets/images/front/salesy-pic-5.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.5s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('assets/images/front/salesy-pic-7.png')); ?>"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.7s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <img src="<?php echo e(asset('assets/images/front/salesy-pic-11.png')); ?>"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 col-sm-12 text-end">
                    ...
                    <p class="text-body">Copyright © Salesy SaaS 2022</p>
                </div>
            </div>
        </div>
    </section>
...
<?php /**PATH D:\Laravel Projects\addonix\resources\views/layouts/landing.blade.php ENDPATH**/ ?>