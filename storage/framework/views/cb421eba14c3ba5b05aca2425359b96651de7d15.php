                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($campaign->status == 0): ?>
                                                    <span
                                                        class="badge bg-warning p-2 px-3 rounded" style="width: 73px;"><?php echo e(__(\App\Models\Campaign::$status[$campaign->status])); ?></span>
                                                <?php elseif($campaign->status == 1): ?>
                                                    <span
                                                        class="badge bg-success p-2 px-3 rounded" style="width: 73px;"><?php echo e(__(\App\Models\Campaign::$status[$campaign->status])); ?></span>
                                                <?php elseif($campaign->status == 2): ?>
                                                    <span
                                                        class="badge bg-danger p-2 px-3 rounded" style="width: 73px;"><?php echo e(__(\App\Models\Campaign::$status[$campaign->status])); ?></span>
                                                <?php elseif($campaign->status == 3): ?>
                                                    <span
                                                        class="badge bg-info p-2 px-3 rounded" style="width: 73px;"><?php echo e(__(\App\Models\Campaign::$status[$campaign->status])); ?></span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Show Campaign')): ?>
                                                        <div class="action-btn bg-warning ms-2">
                                                            <a href="#" data-size="md"
                                                                ...
                                                                data-title="<?php echo e(__('Campaign Details')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\addonix\resources\views/campaign/index.blade.php ENDPATH**/ ?>