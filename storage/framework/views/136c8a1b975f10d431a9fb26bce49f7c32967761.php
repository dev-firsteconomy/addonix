                                    ...
                                    <td class="Action text-end">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit ContractType')): ?>
                                                <div class="action-btn btn-info ms-2">
                                                    <a href="#" data-size="md" data-url="<?php echo e(URL::to('contract_type/'.$contractType->id.'/edit')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Edit Contract Type')); ?>" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Edit')); ?>" ><i class="ti ti-edit text-white"></i></a>
                                                </div>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\addonix\resources\views/contract_type/index.blade.php ENDPATH**/ ?>