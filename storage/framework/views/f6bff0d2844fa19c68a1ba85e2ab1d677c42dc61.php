        ...
        <div class="m-header main-logo">
            <a href="<?php echo e(route('dashboard')); ?>" class="b-brand">
                ...
                <img src="<?php echo e($logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png')); ?>"
                    alt="<?php echo e(config('app.name', 'Salesy')); ?>" class="logo logo-lg nav-sidebar-logo" />
            </a>
        </div>
        ...
        <div class="navbar-content">
            <ul class="dash-navbar">
                ...
                <li class="dash-item <?php echo e(\Request::route()->getName() == 'userlog' ? 'active' : ''); ?>">
                    <a class="dash-link" href=<?php echo e(route('userlog.index')); ?>>
                        <span class="dash-micon"><i class="ti ti-user"></i></span><span class="dash-mtext"><?php echo e(__('User Logs')); ?></span></a>
                </li>
                <?php endif; ?>  -->
                ...
                <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Account')): ?>
                    <li class="dash-item <?php echo e(\Request::route()->getName() == 'account' || \Request::route()->getName() == 'account.edit' ? ' active' : ''); ?>">
                        <a href="<?php echo e(!empty(\Auth::user()->getDefualtViewRouteByModule('account')) ? route(\Auth::user()->getDefualtViewRouteByModule('account')) : route('account.index')); ?>" class="dash-link">
                ...
                <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Contact')): ?>
                    <li class="dash-item <?php echo e(\Request::route()->getName() == 'contact' || \Request::route()->getName() == 'contact.edit' ? ' active' : ''); ?>">
                        <a href="<?php echo e(!empty(\Auth::user()->getDefualtViewRouteByModule('contact')) ? route(\Auth::user()->getDefualtViewRouteByModule('contact')) : route('contact.index')); ?>" class="dash-link ">
                ...
                <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Opportunities')): ?>
                    <li class="dash-item <?php echo e(\Request::route()->getName() == 'opportunities' || \Request::route()->getName() == 'opportunities.edit' ? ' active' : ''); ?>">
                        <a href="<?php echo e(!empty(\Auth::user()->getDefualtViewRouteByModule('opportunities')) ? route(\Auth::user()->getDefualtViewRouteByModule('opportunities')) : route('opportunities.index')); ?>"
                            class="dash-link">
                ...
                <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage CommonCase')): ?>
                    <li class="dash-item <?php echo e(\Request::route()->getName() == 'commoncases' || \Request::route()->getName() == 'commoncases.show' || \Request::route()->getName() == 'commoncases.edit' ? ' active' : ''); ?>">
                        <a href="<?php echo e(!empty(\Auth::user()->getDefualtViewRouteByModule('commoncases')) ? route(\Auth::user()->getDefualtViewRouteByModule('commoncases')) : route('commoncases.index')); ?>" class="dash-link">
                ...
                <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Task')): ?>
                    <li class="dash-item <?php echo e(\Request::route()->getName() == 'task' || \Request::route()->getName() == 'task.show' || \Request::route()->getName() == 'task.edit' || \Request::route()->getName() == 'task.gantt.chart' ? ' active' : ''); ?>">
                        <a href="<?php echo e(!empty(\Auth::user()->getDefualtViewRouteByModule('task')) ? route(\Auth::user()->getDefualtViewRouteByModule('task')) : route('task.index')); ?>" class="dash-link">
                ...
                <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Meeting')): ?>
                    <li class="dash-item <?php echo e(\Request::route()->getName() == 'meeting' || \Request::route()->getName() == 'meeting.show' || \Request::route()->getName() == 'meeting.edit' ? ' active' : ''); ?>">
                        <a href="<?php echo e(!empty(\Auth::user()->getDefualtViewRouteByModule('meeting')) ? route(\Auth::user()->getDefualtViewRouteByModule('meeting')) : route('meeting.index')); ?>"
                            class="dash-link">
                ...
                <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Call')): ?>
                    <li class="dash-item <?php echo e(\Request::route()->getName() == 'call' || \Request::route()->getName() == 'call.show' || \Request::route()->getName() == 'call.edit' ? ' active' : ''); ?>">
                        <a href="<?php echo e(!empty(\Auth::user()->getDefualtViewRouteByModule('call')) ? route(\Auth::user()->getDefualtViewRouteByModule('call')) : route('call.index')); ?>" class="dash-link">
              ...
              <?php endif; ?> -->
                <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Document')): ?>
                    <li class="dash-item <?php echo e(\Request::route()->getName() == 'document' || \Request::route()->getName() == 'document.show' || \Request::route()->getName() == 'document.edit' ? ' active' : ''); ?>">
                        <a href="<?php echo e(!empty(\Auth::user()->getDefualtViewRouteByModule('document')) ? route(\Auth::user()->getDefualtViewRouteByModule('document')) : route('document.index')); ?>" class="dash-link">
                ...
                <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Campaign')): ?>
                    <li class="dash-item <?php echo e(\Request::route()->getName() == 'campaign' || \Request::route()->getName() == 'campaign.show' || \Request::route()->getName() == 'campaign.edit' ? ' active' : ''); ?>">
                        <a href="<?php echo e(!empty(\Auth::user()->getDefualtViewRouteByModule('campaign')) ? route(\Auth::user()->getDefualtViewRouteByModule('campaign')) : route('campaign.index')); ?>" class="dash-link">
...
<?php /**PATH C:\xampp\htdocs\projects\addonix\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>