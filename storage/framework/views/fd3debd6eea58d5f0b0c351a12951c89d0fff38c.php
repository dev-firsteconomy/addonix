                                                        ...
                                                        <div class="logo-content logo-set-bg  text-center py-2">
                                                            ...
                                                            <a href="<?php echo e($logo . 'logo-dark.png'); ?>" target="_blank">
                                                                <img id="blah4" alt="your image"
                                                                    src="<?php echo e($logo . 'logo-dark.png'); ?>" width="170px"
                                                                    class="big-logo">
                                                            </a>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="logo-content logo-set-bg  text-center py-2">
                                                            ...
                                                            <a href="<?php echo e($logo . 'favicon.png'); ?>" target="_blank">
                                                                <img id="blah6" alt="your image"
                                                                    src="<?php echo e($logo . 'favicon.png'); ?>" width="50px"
                                                                    class="img_setting">
                                                            </a>
                                                        </div>
                                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo e(Form::text('pusher_app_id', env('PUSHER_APP_ID'), ['class' => 'form-control font-style', 'placeholder' => 'Pusher App Id', 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo e(Form::text('pusher_app_key', env('PUSHER_APP_KEY'), ['class' => 'form-control font-style', 'placeholder' => 'Pusher App Key', 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo e(Form::text('pusher_app_secret', '', ['class' => 'form-control font-style', 'placeholder' => 'Pusher App Key', 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo e(Form::text('pusher_app_cluster', env('PUSHER_APP_CLUSTER'), ['class' => 'form-control font-style', 'placeholder' => 'Pusher App Cluster', 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="faq justify-content-center">
                                    <div class="col-sm-12 col-md-10 col-xxl-12">
                                        <div class="accordion accordion-flush setting-accordion1" id="accordionExample">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::text('meta_keywords', !empty($seo_setting['meta_keywords']) ? $seo_setting['meta_keywords'] : '', ['class' => 'form-control ', 'placeholder' => 'Meta Keywords'])); ?>

                                        </div>
                                        <div class="form-group">
                                            <?php echo e(Form::label('meta_description', __('Meta Description'), ['class' => 'form-label'])); ?>

                                            <?php echo e(Form::textarea('meta_description', !empty($seo_setting['meta_description']) ? $seo_setting['meta_description'] : '', ['class' => 'form-control ', 'rows' => '5', 'placeholder' => 'Enter Meta Description'])); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <?php
                                                    $src = isset($seo_setting['meta_image']) && !empty($seo_setting['meta_image']) ? asset(Storage::url('uploads/metaevent/' . $seo_setting['meta_image'])) : '';
                                                ?>
                        ...
                        <div class="card" id="cookie">
                            ...
                            <div  class="card-footer text-end d-flex align-items-center gap-2 flex-sm-column flex-lg-row justify-content-between">
                                <div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="logo-content logo-set-bg  text-center py-2">
                                                        ...
                                                        <a href="<?php echo e($logo . '/' . (isset($dark_logo) && !empty($dark_logo) ? $dark_logo : 'logo-dark.png')); ?>"
                                                            target="_blank">
                                                            <img id="blah" alt="your image"
                                                                src="<?php echo e($logo . '/' . (isset($dark_logo) && !empty($dark_logo) ? $dark_logo : 'logo-dark.png')); ?>"
                                                                width="170px" class="">
                                                        </a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body setting-card setting-logo-box p-3">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="logo-content logo-set-bg  text-center py-2">
                                                        <a href="<?php echo e($logo . '/' . (isset($light_logo) && !empty($light_logo) ? $light_logo : 'logo-light.png')); ?>"
                                                            target="_blank">
                                                            <img id="blah1" alt="your image"
                                                                src="<?php echo e($logo . '/' . (isset($light_logo) && !empty($light_logo) ? $light_logo : 'logo-light.png')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <?php echo e(Form::text('company_email', null, ['class' => 'form-control', 'placeholder' => 'Company Email'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <?php echo e(Form::text('company_email_from_name', null, ['class' => 'form-control font-style', 'placeholder' => 'Company Email From Name'])); ?>
                            ...
                            <form id="setting-form" method="post" action="<?php echo e(route('invoice.template.setting')); ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label
                                                class="form-label"for="address"><?php echo e(__('Invoice Template')); ?></label>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\addonix\resources\views/settings/index.blade.php ENDPATH**/ ?>