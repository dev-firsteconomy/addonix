                                ...
                                <tbody>
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="budget"><?php echo e(ucfirst(!empty($product->brands->name) ? $product->brands->name : '-')); ?>
                                            ...
                                            <td>
                                                <?php if($product->status == 0): ?>
                                                    <span
                                                        class="badge bg-success p-2 px-3 rounded" style="width: 88px;"><?php echo e(__(\App\Models\Product::$status[$product->status])); ?></span>
                                                <?php elseif($product->status == 1): ?>
                                                    <span
                                                        class="badge bg-danger p-2 px-3 rounded" style="width: 88px;"><?php echo e(__(\App\Models\Product::$status[$product->status])); ?></span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <span
                                                    class="budget"><?php echo e(\Auth::user()->priceFormat($product->price)); ?></span>
                                            </td>
                                            <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Projects\addonix\resources\views/product/index.blade.php ENDPATH**/ ?>