                ...
                <li class="dropdown dash-h-item drp-company">
                    <a class="dash-head-link dropdown-toggle arrow-none me-0" data-target="#sidenav-main"
                        ...
                        <span class="theme-avtar">
                            ...
                            <?php else: ?>
                            <img class="rounded-circle" src="<?php echo e($profile . '/'); ?><?php echo e(!empty($users->avatar) ? $users->avatar : 'avatar.png'); ?>" style="width:30px;">
                            <?php endif; ?>
                        </span>
                ...
                <li class="dropdown dash-h-item drp-language">
                    ...
                    <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                        <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('change.language', $language)); ?>" class="dropdown-item <?php if($language==$currantLang): ?> active-language text-primary <?php endif; ?>">
...
<?php /**PATH C:\xampp\htdocs\projects\addonix\resources\views/partials/admin/header.blade.php ENDPATH**/ ?>