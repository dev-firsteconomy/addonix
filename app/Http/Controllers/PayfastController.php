...
class PayfastController extends Controller
{
    ...
    public function invoicepaywithpayfast(Request $request)
    {
        ...
        // dd($user);
        // $datatable = json_decode($invoice->json_data, true);
        ...
        if($invoice){
            try {
                ...
                if($invoice_getdue <= 0.0)
                    ...
                    return redirect()->route('pay.invoice',encrypt($invoice_id['invoice_id']))->with('success', __('Payment added Successfully'));
