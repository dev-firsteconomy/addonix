                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('contact', $contacts, null,array('class' => 'form-control ')) !!}
                                        @error('contacts')
                            ...
                            <table class="table datatable" id="datatable">
                                ...
                                <tbody>
                                    @foreach($tasks as $task)
                                        <tr>
                                            <td>
                                                <a href="#" data-size="lg" data-url="{{ route('task.show',$task->id) }}" data-ajax-popup="true" data-title="{{__('Task Details')}}" class="action-item text-primary">
                                                    {{ $task->name }}
                                                </a>
                                            </td>
                                            <td class="budget">
                                            ...
                                            <td class="text-end">
                                                    ...
                                                    @can('Show Task')
                                                        <div class="action-btn bg-warning ms-2">
                                                            <a href="#" data-size="lg" data-url="{{ route('task.show',$task->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Details')}}" data-title="{{__('Task Details')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white">
                                                                <i class="ti ti-eye"></i>
                                                            </a>
                                                        </div>
                                                    @endcan
