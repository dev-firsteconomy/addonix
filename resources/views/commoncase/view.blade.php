    ...
    <div class="col-lg-12">
            ...
            <div class="">
                <dl class="row">
                    ...
                    <dd class="col-md-7"><span class="text-md">{{ $commonCase->name }}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Number')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ $commonCase->number}}</span></dd>
                    ...
                    <dd class="col-md-7"><span class="text-md">{{ !empty($commonCase->accounts)?$commonCase->accounts->name:'-'  }}</span></dd>
                    ...
                    <dd class="col-md-7"><span class="text-md">{{ !empty($commonCase->contacts->name)?$commonCase->contacts->name:'-' }}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Type')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ !empty($commonCase->types)?$commonCase->types->name:'-' }}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Description')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ $commonCase->description }}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{ __('Assigned User') }}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ !empty($commonCase->assign_user)?$commonCase->assign_user->name:'-'}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Created')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{\Auth::user()->dateFormat($commonCase->created_at)}}</span></dd>
                </dl>
            </div>
