                        ...
                        <div data-v-363339a0="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    ...
                                    <div data-v-363339a0="" class="col-2 text-right" style="position: relative;
                                    width: 100%;">
                                        ...
                                        <div data-v-363339a0="" class="">
                                            <table data-v-363339a0="" class="summary-table">
                                                ...
                                                <tr data-v-363339a0="">
                                                    ...
                                                    <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::invoiceNumberFormat($settings,$invoice->Iinvoice)}}</td>
                                                </tr>
                                                <tr data-v-363339a0="">
                                                ...
                                                <tr class="ml-8 " style="    position: absolute;
    right: 0;">
                                                    <td class="">
