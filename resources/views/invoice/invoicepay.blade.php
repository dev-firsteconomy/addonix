                        ...
                        <div class="col-12">
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-6 col-md-8">
                                    ...
                                    <span class="col-sm-8"><span
                                            class="text-sm">{{ $users->dateFormat($invoice->date_invoiced) }}</span></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 ">
                            ...
                            <tbody>
                                ...
                                @foreach ($invoice->payments as $payment)
                                    <tr>
                                        ...
                                        @else
                                            {{ \App\Models\User::dateFormat($payment->date) }}<br><br>
                                        @endif
                                        ...
                                        @else
                                            <td class="text-right">{{ \App\Models\User::priceFormat($payment->amount) }}
                                            </td>
                                        @endif
                                    </tr>
                                @endforeach
                        ...
                        <div class="tab-content">
                            ...
                            @if (isset($payment_setting['is_stripe_enabled']) && $payment_setting['is_stripe_enabled'] == 'on')
                                @if (isset($payment_setting['stripe_key']) &&
                                        !empty($payment_setting['stripe_key']) &&
                                        (isset($payment_setting['stripe_secret']) && !empty($payment_setting['stripe_secret'])))
                                    <div class="tab-pane fade {{ isset($payment_setting['is_stripe_enabled']) && $payment_setting['is_stripe_enabled'] == 'on' ? 'show active' : '' }}"
                                ...
                                @if (isset($payment_setting['is_payfast_enabled']) && $payment_setting['is_payfast_enabled'] == 'on')
                                    @if (isset($payment_setting['payfast_merchant_id']) &&
                                        ...
                                        <form method="post" action={{ 'https://' . $pfHost . '/eng/process' }}
                                            ...
                                            {{-- <div class="col-12 form-group mt-3 text-end">
                                                <input type="submit" value=""{{ __('Make Payment') }}" name="invoice_id" id="invoice_id"
                                                    class="btn btn-print-invoice  btn-primary m-r-10"
                                                    id="pay_with_payfast">
                                            </div> --}}
                                            <div class="text-end">
...
@push('script-page')
    ...
    @endif
    @if ($invoice->getDue() > 0 && isset($payment_setting['is_payfast_enabled']) && $payment_setting['is_payfast_enabled'] == 'on')
    <script>
