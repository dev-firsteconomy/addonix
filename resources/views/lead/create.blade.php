...
<div class="row">
    <div class="col-6">
        <div class="form-group">
            ...
            {{Form::text('name',null,array('class'=>'form-control','placeholder'=>__('Company Name'),'required'=>'required'))}}
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
            {{Form::label('name',__('Company Address'),['class'=>'form-label']) }}
            {{Form::textarea('name',null,array('class'=>'form-control','placeholder'=>__('Company Address'),'required'=>'required','rows'=>'1','cols'=>'10'))}}
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
