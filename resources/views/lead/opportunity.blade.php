...
<div class="row">
    ...
    <div class="col-4">
        <div class="form-group">
            {{Form::label('estimated_close_date',__('Estimated Close Date'),['class'=>'form-label']) }}
            {{Form::date('estimated_close_date',null,array('class'=>'form-control','required'=>'required'))}}
        </div>
    </div>
    <div class="col-4">
        <div class="form-group">
            {{Form::label('assign_user_id',__('Assign To'),['class'=>'form-label']) }}
