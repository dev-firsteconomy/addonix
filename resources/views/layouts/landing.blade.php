    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
          ...
          /> --}}
            ...
            <div class="mt-5">
                <img src="{{ asset('assets/images/front/salesy-pic-1.png') }}" alt=""
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('assets/images/front/salesy-pic-1.png') }}" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
