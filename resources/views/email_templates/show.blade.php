                                            ...
                                            @if($emailTemplate->slug=='new_user')
                                                ...
                                                @elseif($emailTemplate->slug=='lead_assigned')
                                                    <div class="row">
                                                        ...
                                                        <p class="col-6">{{__('Lead Assign User')}} : <span class="pull-right text-primary">{lead_assign_user}</span></p>
                                                        <p class="col-6">{{__('Lead Description')}} : <span class="pull-right text-primary">{lead_description}</span></p>
                                                        <p class="col-6">{{__('Lead Source')}} : <span class="pull-right text-primary">{lead_source}</span></p>
                                                    </div>
                                                @elseif($emailTemplate->slug=='task_assigned')
                                                        <div class="row">
                                                            ...
                                                            <p class="col-6">{{__('Company Name')}} : <span class="pull-right text-primary">{company_name}</span></p>
                                                            <p class="col-6">{{__('App Url')}} : <span class="pull-right text-primary">{app_url}</span></p>
                                                            <p class="col-6">{{__('Task Name')}} : <span class="pull-right text-primary">{task_name}</span></p>
                                                ...
                                                @elseif($emailTemplate->slug=='quote_created')
                                                    <div class="row">
                                                        ...
                                                        <p class="col-6">{{__('Company Name')}} : <span class="pull-right text-primary">{company_name}</span></p>
                                                        <p class="col-6">{{__('App Url')}} : <span class="pull-right text-primary">{app_url}</span></p>
                                                        <p class="col-6">{{__('Quote Number')}} : <span class="pull-right text-primary">{quote_number}</span></p>
                                                        <p class="col-6">{{__('Billing Address')}} : <span class="pull-right text-primary">{billing_address}</span></p>
                                                        <p class="col-6">{{__('Shipping Address')}} : <span class="pull-right text-primary">{shipping_address}</span></p>
                                                        <p class="col-6">{{__('Quotation Description')}} : <span class="pull-right text-primary">{description}</span></p>
                                                        <p class="col-6">{{__('Quote Assign User')}} : <span class="pull-right text-primary">{quote_assign_user}</span></p>
                                                        <p class="col-6">{{__('Quoted Date')}} : <span class="pull-right text-primary">{date_quoted}</span></p>
                                                    </div>
                                                @elseif($emailTemplate->slug=='new_sales_order')
                                                    <div class="row">
                                                        ...
                                                        <p class="col-6">{{__('Quotation Description')}} : <span class="pull-right text-primary">{description}</span></p>
                                                        <p class="col-6">{{__('Quoted Date')}} : <span class="pull-right text-primary">{date_quoted}</span></p>
                                                        <p class="col-6">{{__('Salesorder Assign User')}} : <span class="pull-right text-primary">{salesorder_assign_user}</span></p>
                                                ...
                                                @elseif($emailTemplate->slug=='new_invoice' || $emailTemplate->slug=='invoice_payment_recored')
                                                    <div class="row">
                                                        ...
                                                        <p class="col-6">{{__('Invoice Issue Date')}} : <span class="pull-right text-primary">{created_at}</span></p>
                                                ...
                                                @elseif($emailTemplate->slug=='meeting_assigned')
                                                    <div class="row">
                                                        ...
                                                        <p class="col-6">{{__('Company Name')}} : <span class="pull-right text-primary">{company_name}</span></p>
                                                        <p class="col-6">{{__('App Url')}} : <span class="pull-right text-primary">{app_url}</span></p>
                                                        <p class="col-6">{{__('Attendees User')}} : <span class="pull-right text-primary">{attendees_user}</span></p>
                                                        <p class="col-6">{{__('Attendees Contact')}} : <span class="pull-right text-primary">{attendees_contact}</span></p>
                                                        <p class="col-6">{{__('Meeting Title')}} : <span class="pull-right text-primary">{meeting_name}</span></p>
                                                        <p class="col-6">{{__('Meeting Start Date')}} : <span class="pull-right text-primary">{meeting_start_date}</span></p>
                                                        <p class="col-6">{{__('Meeting Due Date')}} : <span class="pull-right text-primary">{meeting_due_date}</span></p>
                                                        <p class="col-6">{{__('Meeting Assign User')}} : <span class="pull-right text-primary">{meeting_assign_user}</span></p>
                                                        <p class="col-6">{{__('Meeting Description')}} : <span class="pull-right text-primary">{meeting_description}</span></p>
                                                    </div>
                                                @elseif($emailTemplate->slug=='campaign_assigned')
                                                    <div class="row">
                                                        ...
                                                        <p class="col-6">{{__('Company Name')}} : <span class="pull-right text-primary">{company_name}</span></p>
                                                        <p class="col-6">{{__('App Url')}} : <span class="pull-right text-primary">{app_url}</span></p>
                                                        <p class="col-6">{{__('Campaign Title')}} : <span class="pull-right text-primary">{campaign_title}</span></p>
                                                        <p class="col-6">{{__('Campaign Status')}} : <span class="pull-right text-primary">{campaign_status}</span></p>
                                                        <p class="col-6">{{__('Campaign Start Date')}} : <span class="pull-right text-primary">{campaign_start_date}</span></p>
                                                        <p class="col-6">{{__('Campaign Due Date')}} : <span class="pull-right text-primary">{campaign_due_date}</span></p>
                                                        <p class="col-6">{{__('Campaign Assign User')}} : <span class="pull-right text-primary">{campaign_assign_user}</span></p>
                                                        <p class="col-6">{{__('Campaign Description')}} : <span class="pull-right text-primary">{campaign_description}</span></p>
                                                    </div>
