...
@section('action-btn')
    <div class="btn-group" role="group">
        ...
        <div class="action-btn  ms-2">
            <a href="{{ route('call.edit',$previous) }}" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="tooltip" title="{{__('Previous')}}">
        ...
        @if(!empty($next))
        <div class="action-btn  ms-2">
            <a href="{{ route('call.edit',$next) }}" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="tooltip" title="{{__('Next')}}">
        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                <div id="useradd-1" class="card">
                    {{Form::model($call,array('route' => array('call.update', $call->id), 'method' => 'PUT')) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {!!Form::date('end_date', date('Y-m-d'),array('class' => 'form-control datepicker','required'=>'required')) !!}
                                        @error('end_date')
