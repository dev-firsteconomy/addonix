    ...
    <div class="col-lg-12">
            ...
            <div class="">
                <dl class="row">
                    ...
                    <dd class="col-md-7"><span class="text-md">{{ $call->name }}</span></dd>
                    ...
                    <dd class="col-md-7"><span class="text-md">{{\Auth::user()->dateFormat($call->start_date)}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('End Date')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{\Auth::user()->dateFormat($call->end_date)}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Parent')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ $call->parent }}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Parent User')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">
                    ...
                    <dd class="col-sm-7"><span class="text-md">{{ $call->description }}</span></dd>


                    <dt class="col-sm-5"><span class="h6 text-md mb-0">{{__('Attendees User')}}</span></dt>
                    <dd class="col-sm-7"><span class="text-md">{{ !empty($call->attendees_users->name)?$call->attendees_users->name:'-' }}</span></dd>

                    <dt class="col-sm-5"><span class="h6 text-md mb-0">{{__('Attendees Contact')}}</span></dt>
                    <dd class="col-sm-7"><span class="text-md">{{ !empty($call->attendees_contacts->name)?$call->attendees_contacts->name:'-' }}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Attendees Lead')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ !empty($call->attendees_leads->name)?$call->attendees_leads->name:'-' }}</span></dd>

                    <dt class="col-sm-5"><span class="h6 text-sm mb-0">{{__('Assigned User')}}</span></dt>
                    <dd class="col-sm-7"><span class="text-sm">{{ !empty($call->assign_user)?$call->assign_user->name:''}}</span></dd>

                    <dt class="col-sm-5"><span class="h6 text-sm mb-0">{{__('Created')}}</span></dt>
                    <dd class="col-sm-7"><span class="text-sm">{{\Auth::user()->dateFormat($call->created_at)}}</span></dd>
