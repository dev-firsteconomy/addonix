                                                        ...
                                                        <div class="logo-content logo-set-bg  text-center py-2">
                                                            ...
                                                            <a href="{{ $logo . 'logo-dark.png' }}" target="_blank">
                                                                <img id="blah4" alt="your image"
                                                                    src="{{ $logo . 'logo-dark.png' }}" width="170px"
                                                                    class="big-logo">
                                                            </a>
                                                        </div>
                                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <div class="form-group col-md-6">
                                        ...
                                        {{ Form::text('pusher_app_id', env('PUSHER_APP_ID'), ['class' => 'form-control font-style', 'placeholder' => 'Pusher App Id', 'required' => 'required']) }}
                                        @error('pusher_app_id')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        {{ Form::text('pusher_app_key', env('PUSHER_APP_KEY'), ['class' => 'form-control font-style', 'placeholder' => 'Pusher App Key', 'required' => 'required']) }}
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        {{ Form::text('pusher_app_secret', '', ['class' => 'form-control font-style', 'placeholder' => 'Pusher App Key', 'required' => 'required']) }}
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        {{ Form::text('pusher_app_cluster', env('PUSHER_APP_CLUSTER'), ['class' => 'form-control font-style', 'placeholder' => 'Pusher App Cluster', 'required' => 'required']) }}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('meta_keywords', !empty($seo_setting['meta_keywords']) ? $seo_setting['meta_keywords'] : '', ['class' => 'form-control ', 'placeholder' => 'Meta Keywords']) }}
                                        </div>
                                        <div class="form-group">
                                            {{ Form::label('meta_description', __('Meta Description'), ['class' => 'form-label']) }}
                                            {{ Form::textarea('meta_description', !empty($seo_setting['meta_description']) ? $seo_setting['meta_description'] : '', ['class' => 'form-control ', 'rows' => '5', 'placeholder' => 'Enter Meta Description']) }}
                                        </div>
                            ...
                            <form id="setting-form" method="post" action="{{ route('invoice.template.setting') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label
                                                class="form-label"for="address">{{ __('Invoice Template') }}</label>
