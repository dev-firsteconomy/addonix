                                                ...
                                                <div class="form-group mt-2">
                                                    {{-- <div class="d-flex radio-check">
                                                        <div class="form-check">
                                                            <input type="radio" id="lead_on" value="lead" name="is_convert" class="form-check-input">
                                                            <label class="form-check-label" for="lead_on">{{__('Lead')}}</label>
                                                        </div>
                                                        <div class="form-check ms-3">
                                                            <input type="radio" id="account_on" value="account" name="is_convert" class="form-check-input" >
                                                            <label class="form-check-label" for="account_on">{{__('Account')}}</label>
                                                        </div>
                                                        <div class="form-check ms-3">
                                                            <input type="radio" id="contact_on" value="contact" name="is_convert" class="form-check-input">
                                                            <label class="form-check-label" for="contact_on">{{__('Contact')}}</label>
                                                        </div>
                                                    </div> --}}
                                                </div>
