                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::date('expiration_date', date('Y-m-d'), ['class' => 'form-control datepicker', 'required' => 'required']) !!}
                                            ...
                                            <div class="attachment-button">
                                                <div class="pull-left">
                                                    <div class="form-group">
                                                        ...
                                                        <img id="blah" src="{{(!empty($document->attachment))?  \App\Models\Utility::get_file( 'upload/profile'.'/'.$document->attachment): \App\Models\Utility::get_file("upload/profile/avatar.png")}}" width="20%" height="20%"/>
                                                        </div>
                                                </div>
                                            </div>
                                            @error('description')
