    ...
    <div class="col-lg-12">
            ...
            <div class="">
                <dl class="row">
                    ...
                    <dd class="col-md-7"><span class="text-md">{{ $document->name }}</span></dd>
                    ...
                    <dd class="col-md-7"><span class="text-md">{{ $document->types->name}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Account')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ !empty($document->accounts)?$document->accounts->name:'-'}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Opportunities')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ !empty($document->opportunitys)?$document->opportunitys->name:'-'}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Publish Date')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{\Auth::user()->dateFormat($document->publish_date)}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Expiration Date')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{\Auth::user()->dateFormat($document->expiration_date)}}</span></dd>


                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Description')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ $document->description }}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('File')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ !empty($document->attachment)?$document->attachment:'No File' }}</span></dd>
