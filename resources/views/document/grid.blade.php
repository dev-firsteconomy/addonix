...
@endsection
@section('action-btn')
    <a href="{{ route('document.index') }}" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="tooltip" title="{{ __('List View') }}">
        <i class="ti ti-list text-white"></i>
    </a>
    
    @can('Create Document')
            <a href="#" data-size="lg" data-url="{{ route('document.create',['document',0]) }}" data-ajax-popup="true" data-bs-toggle="tooltip" data-title="{{__('Create New Document')}}"title="{{__('Create')}}" class="btn btn-sm btn-primary btn-icon m-1">
...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        <a href="#" class="btn-addnew-project"  data-ajax-popup="true" data-size="lg" data-title="{{ __('Create New Document') }}" data-url="{{ route('document.create',['document',0]) }}">
