                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" data-size="md"
                                                    ...
                                                    data-ajax-popup="true" data-title="{{ __('Document Details') }}"
                                            ...
                                            <td class="budget">
                                                ...
                                                @if (!empty($document->attachment))
                                                    <a href="{{ $profile. '/' . $document->attachment }}"
                                            ...
                                            <td>
                                                @if ($document->status == 0)
                                                    <span
                                                        class="badge bg-success p-2 px-3 rounded" style="width: 73px;">{{ __(\App\Models\Document::$status[$document->status]) }}</span>
                                                @elseif($document->status == 1)
                                                    <span
                                                        class="badge bg-warning p-2 px-3 rounded" style="width: 73px;">{{ __(\App\Models\Document::$status[$document->status]) }}</span>
                                                @elseif($document->status == 2)
                                                    <span
                                                        class="badge bg-danger p-2 px-3 rounded" style="width: 73px;">{{ __(\App\Models\Document::$status[$document->status]) }}</span>
