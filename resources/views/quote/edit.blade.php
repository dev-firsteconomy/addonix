            ...
            <div class="col-xl-3">
                <div class="card sticky-top" style="top:30px">
                    <div class="list-group list-group-flush" id="useradd-sidenav">
                        ...
                        <a href="#useradd-3" class="list-group-item list-group-item-action border-0">{{__('Invoice')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                    </div>
                </div>
            </div>
            <div class="col-xl-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('tax[]', $tax,explode(',',$quote->tax), array('class' => 'form-control select2','id'=>'choices-multiple1','multiple'=>'')) }}
                                        @error('tax')
                ...
                <div id="useradd-2" class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="float-end">
                                    <a href="#" data-size="lg" data-url="{{ route('salesorder.create',['quote',$quote->id]) }}" data-bs-toggle="tooltip"data-ajax-popup="true" title="{{__('Create')}}"data-title="{{__('Create New Sales Orders')}}" class="btn btn-sm btn-primary btn-icon-only">
                                ...
                                <tbody>
                                    @foreach($salesorders as $salesorder)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="budget">{{\Auth::user()->priceFormat($salesorder->amount)}}</span>
                                            </td>
                                            <td class="text-right">
                                                @can('Show SalesOrder')
                                                ...
                                                @can('Edit SalesOrder')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="{{ route('salesorder.edit',$salesorder->id) }}" data-bs-toggle="tooltip" title="{{__('Edit')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white" data-title="{{__('Edit SalesOrders')}}"><i class="ti ti-edit"></i></a>
                                                    </div>
                                                @endcan
                ...
                <div id="useradd-3" class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="float-end">
                                    <a href="#" data-size="lg" data-url="{{ route('invoice.create',['quote',$quote->id]) }}" data-ajax-popup="true" data-bs-toggle="tooltip" data-title="{{__('Create New Invoice')}}" title="{{__('Create')}}" class="btn btn-sm btn-primary btn-icon-only ">
                                        <i class="ti ti-plus"></i>
                                    </a>
                                </div>
                            </div>
                            ...
                            <table class="table datatable" id="datatable1">
                                ...
                                <tbody>
                                    @foreach($invoices as $invoice)
                                        <tr>
                                            <td>
                                                <a href="{{ route('invoice.show',$invoice->id) }}" class="action-item text-primary" data-title="{{__('Invoice Details')}}">
                                                    {{ $invoice->name }}
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                @elseif($invoice->status == 5)
                                                    <span class="badge bg-danger p-2 px-3 roundedr">{{ __(\App\Models\Invoice::$status[$invoice->status]) }}</span>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span class="budget">{{\Auth::user()->priceFormat($invoice->amount)}}</span>
                                            </td>
                                            <td class="text-right">
                                                @can('Show Invoice')
                                                    <div class="action-btn bg-warning ms-2">
                                                        <a href="{{ route('invoice.show',$invoice->id) }}" data-bs-toggle="tooltip" title="{{__('Details')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white" data-title="{{__('Invoice Details')}}">
                                                            <i class="ti ti-eye"></i>
                                                        </a>
                                                    </div>
                                                @endcan
                                                @can('Edit Invoice')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="{{ route('invoice.edit',$invoice->id) }}" data-bs-toggle="tooltip" title="{{__('Edit')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white" data-title="{{__('Edit Invoice')}}"><i class="ti ti-edit"></i></a>
                                                    </div>
                                                @endcan
                                                @can('Delete Invoice')
                                                    <div class="action-btn bg-danger ms-2">
