                        ...
                        <div data-v-b8f60a0c="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-33"><h1 data-v-b8f60a0c="" class="fancy-title tu mb5" style="color: {{$color}}; border-top: 15px solid {{$color}};">{{__('QUOTE')}}</h1></div>
                                    <div data-v-b8f60a0c="" class="col-33"></div>
                                    <div data-v-b8f60a0c="" class="col-33"><img data-v-b8f60a0c="" style="max-width: 250px;" class="d-logo" src="{{$img}}">
                                    </div>
                                </div>
                                ...
                                <div data-v-b8f60a0c="" class="break-50">

                                </div>

                                <div data-v-b8f60a0c="" class="">
