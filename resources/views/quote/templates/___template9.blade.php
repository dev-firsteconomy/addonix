                ...
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-7d9d14b5="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};" style="position: relative">
                                <div data-v-7d9d14b5="" class="row" style="position: relative;">
                                    <div data-v-7d9d14b5="" class="col-2"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('QUOTE')}}</h1>
                                        <h3 data-v-7d9d14b5="">{{\App\Models\Utility::invoiceNumberFormat($settings,$quote->invoice)}}</h3>
                                        <p data-v-7d9d14b5="">{{\App\Models\Utility::dateFormat($settings,$quote->date_quoted)}}</p>
                                        <div class="ml-8 mt-5">
