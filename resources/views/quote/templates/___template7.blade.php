                    ...
                    <div class="preview-main client-preview">
                        <div data-v-1ad6e3b9="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-1ad6e3b9="" class="d-inner d-no-pad" style="border-top: 15px solid {{$color}}; border-bottom: 15px solid {{$color}};">
                                <div data-v-1ad6e3b9="" class="row grey-box" style="justify-content: space-between;">
                                    <div data-v-1ad6e3b9="" class="col-33"><img data-v-1ad6e3b9="" src="{{$img}}" class="d-logo" style="max-width: 250px;">
                                        <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                    </div>
                                    <div data-v-1ad6e3b9="" class="col-33">&nbsp;</div>
                                    <div class="row" style="width: 100%; position: relative;">
                                        <div data-v-1ad6e3b9="" class="col-12">
                                            <h1 data-v-1ad6e3b9="" class="fancy-title mb5">
                                                {{__('QUOTE')}}
                                            </h1> <br data-v-1ad6e3b9="">
                                            <br data-v-1ad6e3b9="">
                                            <div class="">
                                                <p>{!! DNS2D::getBarcodeHTML(route('pay.quote',\Illuminate\Support\Facades\Crypt::encrypt($quote->id)), "QRCODE",2,2) !!}</p>
                                            </div>
                                            <table data-v-1ad6e3b9="" class="summary-table" style="position: relative;">
                                                <tbody data-v-1ad6e3b9="">
                                                <tr data-v-363339a0="">
                                                    <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Number')}}:</td>
                                                    <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::quoteNumberFormat($settings,$quote->quote)}}</td>
                                                </tr>
                                                <tr data-v-363339a0="">
                                                    <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Issue Date')}}:</td>
                                                    <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::dateFormat($settings,$quote->date_quoted)}}</td>
                                    ...
                                    <div data-v-363339a0="" class="d-table">
                                        <div data-v-363339a0="" class="d-table">
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">{{\App\Models\Utility::priceFormat($settings,$quote->totalRate)}}</pre>
                                                </div>
                                                <div class="d-table-td w-6">
                                                    <pre data-v-f2a183a6="">{{\App\Models\Utility::priceFormat($settings,$quote->totalTaxPrice) }}</pre>
                                                </div>
                                                @if($quote->discount_apply==1)
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6="">{{\App\Models\Utility::priceFormat($settings,$quote->totalDiscount)}}</pre>
                                                    </div>
                                                @else
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6="">-</pre>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    @if($quote->discount_apply==1)
                                                        @if($quote->getTotalDiscount())
                                                            <div data-v-f2a183a6="" class="d-table-summary-item">
                                                                ...
                                                                <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,$quote->getTotalDiscount())}}</div>
                                                            </div>
                                                        @endif
                                                    @endif
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,$quote->getSubTotal()-$quote->getTotalDiscount()+$quote->getTotalTax())}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
