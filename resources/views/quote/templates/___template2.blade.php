                    ...
                    <div class="preview-main client-preview">
                        <div data-v-37eeda86="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-37eeda86="" class="d-inner">
                                ...
                                <div data-v-37eeda86="">
                                    <strong data-v-37eeda86="" class="tu mb5" style="color: {{$color}};">{{__('QUOTE')}}</strong>
                                    <table data-v-37eeda86="" class="summary-table" style="position: relative;">
                                        ...
                                        <tr data-v-363339a0="">
                                            ...
                                            <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::dateFormat($settings,$quote->issue_date)}}</td>
                                        </tr>
                                        <tr data-v-363339a0="">
                                            <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Due Date')}}:</td>
                                            <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::dateFormat($settings,$quote->due_date)}}</td>
                                        </tr>
                                ...
                                <div data-v-37eeda86="" class="break-150 col-66"></div>
