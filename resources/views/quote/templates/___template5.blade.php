                ...
                <div class="invoice-preview-inner">
                    <div class="editor-content">
                        <div class="preview-main client-preview">
                            <div data-v-e23d9750="" class="d" style="width:800px;margin-left: auto;margin-right: auto;"
                                id="boxes">
                                                ...
                                                <tbody data-v-e23d9750="" style="position: relative;">
                                                    ...
                                                    <tr data-v-363339a0="">
                                                        <td data-v-363339a0="" class="tu fwb"
                                                            ...
                                                            {{ __('Issue Date') }}:</td>
                                                        <td data-v-363339a0="" class="text-right">
                                                            {{ \App\Models\Utility::dateFormat($settings, $quote->date_quoted) }}
                                                        </td>
                                                    </tr>
                                                    <tr class="ml-8">
                                                        <td class="">
                                                            <p>{!! DNS2D::getBarcodeHTML(route('pay.quote', \Illuminate\Support\Facades\Crypt::encrypt($quote->id)), 'QRCODE', 2, 2) !!}</p>
                                                        </td>

                                                    </tr>
                                                </tbody>
                                            </table>
                                            <strong data-v-f2a183a6="" class="mt-3">{{ __('From') }}:</strong>
                                            <p>
                                                @if ($settings['company_name'])
                                                    {{ $settings['company_name'] }}@endif<br>
                                                @if ($settings['company_address'])
                                                    {{ $settings['company_address'] }}@endif
                                                @if ($settings['company_city']) <br>
                                                    {{ $settings['company_city'] }}, @endif
                                                @if ($settings['company_state'])
                                                    {{ $settings['company_state'] }}@endif
                                                @if ($settings['company_zipcode']) -
                                                    {{ $settings['company_zipcode'] }}@endif
                                                @if ($settings['company_country'])
                                                    <br>{{ $settings['company_country'] }}@endif
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div data-v-363339a0="" class="d-table">
                                        <div data-v-363339a0="" class="d-table">
                                                ...
                                                @if (isset($quote->items) && count($quote->items) > 0)
                                                    @foreach ($quote->items as $key => $item)
                                                        ...
                                                        <div class="d-table-tr"
                                                            ...
                                                            <div class="d-table-td w-3">
                                                                <pre
                                                                    data-v-f2a183a6="">{{ \App\Models\Utility::priceFormat($settings, $item->price) }}</pre>
                                                            </div>
                                                            ...
                                                            @if ($item->discount != 0)
                                                                <div class="d-table-td w-3">
                                                                    <pre
                                                                        data-v-f2a183a6="">{{ \App\Models\Utility::priceFormat($settings, $item->discount) }}</pre>
                                                                </div>
                                                            @else
                                                                <div class="d-table-td w-3">
                                                            ...
                                                            <div class="d-table-td w-4 text-right">
                                                                <span>{{ \App\Models\Utility::priceFormat($settings, $item->price * $item->quantity) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
                                            ...
                                            <div class="d-table-tr"
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">{{ $quote->totalQuantity }}</pre>
                                                </div>
                                                <div class="d-table-td w-3">
                                                    <pre
                                                        data-v-f2a183a6="">{{ \App\Models\Utility::priceFormat($settings, $quote->totalRate) }}</pre>
                                                </div>
                                                <div class="d-table-td w-6">
                                                    <pre
                                                        data-v-f2a183a6="">{{ \App\Models\Utility::priceFormat($settings, $quote->totalTaxPrice) }}</pre>
                                                </div>
                                                @if ($quote->discount_apply == 1)
                                                    <div class="d-table-td w-3">
                                                        <pre
                                                            data-v-f2a183a6="">{{ \App\Models\Utility::priceFormat($settings, $quote->totalDiscount) }}</pre>
                                                    </div>
                                                @else
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6="">-</pre>
                                                ...
                                                <div class="d-table-td w-4 text-right">
                                                    <span>{{ \App\Models\Utility::priceFormat($settings, $quote->getSubTotal()) }}
                                                    </span>
                                                </div>
                                            </div>
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                        ...
                                                        @if ($quote->getTotalDiscount())
                                                            <div data-v-f2a183a6="" class="d-table-summary-item">
                                                                ...
                                                                <div data-v-f2a183a6="" class="d-table-value">
                                                                    {{ \App\Models\Utility::priceFormat($settings, $quote->getTotalDiscount()) }}
                                                                </div>
                                                            </div>
                                                        @endif
                                                    @endif
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item"
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-label">
                                                            {{ __('Total') }}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">
                                                            {{ \App\Models\Utility::priceFormat($settings, $quote->getSubTotal() - $quote->getTotalDiscount() + $quote->getTotalTax()) }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
