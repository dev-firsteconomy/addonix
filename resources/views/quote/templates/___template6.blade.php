                        ...
                        <div data-v-4b3dcb8a="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid {{$color}};">
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-2"><h1 data-v-4b3dcb8a="" class="fancy-title mb-5">{{__('QUOTE')}}</h1>
                                ...
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-1" style="position: relative;">
                                    ...
                                    <div data-v-4b3dcb8a="" class="">
                                        <table data-v-4b3dcb8a="" class="summary-table" style="position: relative;">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::invoiceNumberFormat($settings,$quote->quote)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
