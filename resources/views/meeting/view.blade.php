    ...
    <div class="col-lg-12">
            ...
            <div class="">
                <dl class="row">
                    ...
                    <dd class="col-md-7"><span class="text-md">{{ $meeting->name }}</span></dd>
                    ...
                    <dd class="col-md-7"><span class="text-md">{{\Auth::user()->dateFormat($meeting->start_date)}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('End Date')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{\Auth::user()->dateFormat($meeting->end_date)}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Parent')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ $meeting->parent }}</span></dd>
                    ...
                    <dd class="col-md-7"><span class="text-md">{{ $meeting->description }}</span></dd>


                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Attendees User')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ !empty($meeting->attendees_users->name)?$meeting->attendees_users->name:'--' }}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Attendees Contact')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ !empty($meeting->attendees_contacts->name)?$meeting->attendees_contacts->name:'--' }}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Attendees Lead')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ !empty($meeting->attendees_leads->name)?$meeting->attendees_leads->name:'--' }}</span></dd>
