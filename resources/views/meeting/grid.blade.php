...
@endsection
@section('action-btn')
    <a href="{{ route('meeting.index') }}" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="tooltip" title="{{ __('List View') }}">
...
<div class="row">
                    ...
                    <div class="card-header-right">
                        <div class="btn-group card-option">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="#!" class="mx-3 btn btn-sm d-inline-flex align-items-center show_confirm" data-bs-toggle="tooltip" >
    ...
    <div class="col-md-3">
        ...
        <a href="#" class="btn-addnew-project"  data-ajax-popup="true" data-size="lg" data-title="{{ __('Create New Meeting') }}" data-url="{{ route('meeting.create') }}">
