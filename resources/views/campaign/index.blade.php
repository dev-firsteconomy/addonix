                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($campaign->status == 0)
                                                    <span
                                                        class="badge bg-warning p-2 px-3 rounded" style="width: 73px;">{{ __(\App\Models\Campaign::$status[$campaign->status]) }}</span>
                                                @elseif($campaign->status == 1)
                                                    <span
                                                        class="badge bg-success p-2 px-3 rounded" style="width: 73px;">{{ __(\App\Models\Campaign::$status[$campaign->status]) }}</span>
                                                @elseif($campaign->status == 2)
                                                    <span
                                                        class="badge bg-danger p-2 px-3 rounded" style="width: 73px;">{{ __(\App\Models\Campaign::$status[$campaign->status]) }}</span>
                                                @elseif($campaign->status == 3)
                                                    <span
                                                        class="badge bg-info p-2 px-3 rounded" style="width: 73px;">{{ __(\App\Models\Campaign::$status[$campaign->status]) }}</span>
                                                @endif
                                            </td>
                                            <td>
                                                    ...
                                                    @can('Show Campaign')
                                                        <div class="action-btn bg-warning ms-2">
                                                            <a href="#" data-size="md"
                                                                ...
                                                                data-title="{{ __('Campaign Details') }}"
