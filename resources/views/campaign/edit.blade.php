                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('excludingtarget_list', $target_list, null, ['class' => 'form-control ', 'required' => 'required']) !!}
                                        </div>
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <small
                                        class="text-muted">{{ __('Assign opportunities for this campaign') }}</small>
                                </div>
                                <div class="col">
                                    <div class="float-end">
                                        <a href="#" data-size="lg"
                                            ...
                                            data-title="{{ __('Create New Opportunities') }}" title="{{ __('Create') }}"
                                ...
                                <table class="table datatable" id="datatable">
                                    ...
                                    <tbody>
                                        @foreach ($opportunitiess as $opportunities)
                                            <tr>
                                                <td>
                                                    <a href="#" class="name mb-0 h6 text-sm text-primary">
                                                        {{ $opportunities->name }}</a>
                                                </td>
                                                <td class="budget">
                                                    <a
                                                        href="#">{{ !empty($opportunities->accounts) ? $opportunities->accounts->name : '' }}</a>
                                                </td>
                                                <td>
                                                    <span class="budget">
                                                        <a
                                                            href="#">{{ !empty($opportunities->stages->name) ? $opportunities->stages->name : '' }}</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span
                                                        ...
                                                        @can('Show Opportunities')
                                                            <div class="action-btn bg-warning ms-2">
                                                                <a href="#" data-size="md"
                                                                    ...
                                                                    data-title="{{ __('show Opportunities') }}"
                                                                    title="{{ __('show') }}"
                                                        ...
                                                        @can('Edit Opportunities')
                                                            <div class="action-btn bg-info ms-2">
                                                                <a href="{{ route('opportunities.edit', $opportunities->id) }}"
                                                                    ...
                                                                    data-title="{{ __('Edit Opportunities') }}"
