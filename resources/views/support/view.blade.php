    ...
    <div class="col-lg-12">
            ...
            <div class="">
                <dl class="row">
                    ...
                    <dd class="col-md-7"><span class="text-md">{{ !empty($product->Brands)?$product->Brands->name:'-'}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Price')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{\Auth::user()->priceFormat($product->price)}}</span></dd>
                    ...
                    <dd class="col-md-7"><span class="text-md">{{ $product->part_number}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Weight')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ $product->weight}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('URL')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ $product->URL}}</span></dd>
