...
@section('action-btn')
    @can('Create Call')
            ...
            <a href="#" data-size="lg" data-url="{{ route('call.create') }}" data-ajax-popup="true" data-title="{{__('Create New Call')}}" class="btn btn-sm btn-primary ms-2">
                {{__('Add Call')}}
            </a>
    @endcan
    @can('Create Meeting')

            <a href="#" data-size="lg" data-url="{{ route('meeting.create') }}" data-ajax-popup="true" data-title="{{__('Create New Meeting')}}" class="btn btn-sm btn-info">
                {{__('Add Meeting')}}
            </a>
    @endcan
    @can('Create Task')

            <a href="#" data-size="lg" data-url="{{ route('task.create') }}" data-ajax-popup="true" data-title="{{__('Create New Task')}}" class="btn btn-sm btn-success ">
                {{__('Add Task')}}
            </a>
    @endcan
