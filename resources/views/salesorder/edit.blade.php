                ...
                <div class="col-xl-3">
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#useradd-2" class="list-group-item list-group-item-action border-0">{{__('Invoice')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('tax[]', $tax,explode(',',$salesOrder->tax), array('class' => 'form-control select2','id'=>'choices-multiple','multiple'=>'')) }}
                                            @error('tax')
                    ...
                    <div id="useradd-2" class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="float-end">
                                        <a href="#" data-size="lg" data-url="{{ route('invoice.create',['salesorder',$salesOrder->id]) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create New Invoice')}}" class="btn btn-sm btn-primary btn-icon-only ">
                                                ...
                                                <td class="text-end">
                                                    @can('Show Invoice')
                                                        <div class="action-btn bg-warning ms-2">
                                                            <a href="{{ route('invoice.show',$invoice->id) }}" data-bs-toggle="tooltip" data-original-title="{{__('Details')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white" title="{{__('Invoice Details')}}">
                                                                <i class="ti ti-eye"></i>
                                                            </a>
                                                        </div>
                                                    @endcan
                                                    @can('Edit Invoice')
                                                        <div class="action-btn bg-info ms-2">
                                                            <a href="{{ route('invoice.edit',$invoice->id) }}" data-bs-toggle="tooltip" data-original-title="{{__('Edit')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white" title="{{__('Edit Invoice')}}"><i class="ti ti-edit"></i></a>
                                                        </div>
                                                    @endcan
                                                    @can('Delete Invoice')
