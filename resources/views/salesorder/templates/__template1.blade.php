...
<div class="container">
    <div id="app" class="content">
        <div class="editor">
            <div class="salesorder-preview-inner">
                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: {{$color}};color:{{$font_color}}">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    <div data-v-f2a183a6="" class="d-header-50">
                                        ...
                                        <div data-v-f2a183a6="" class="break-25">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title">{{__('SALES ORDER')}}</div>
                                        <table data-v-f2a183a6="" class="summary-table">
                                            <tbody data-v-f2a183a6="" style="position: relative">
                                            <tr>
                                                <td>{{__('Number')}}:</td>
                                                <td>{{\App\Models\Utility::salesorderNumberFormat($settings,$salesorder->quote)}}</td>
                                            </tr>
                                            <tr>
                                                <td>{{__('Issue Date')}}:</td>
                                                <td>{{\App\Models\Utility::dateFormat($settings,$salesorder->issue_date)}}</td>
                                            </tr>
