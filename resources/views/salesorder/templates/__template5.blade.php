                        ...
                        <div data-v-e23d9750="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-e23d9750="" class="d-inner">
                                <div data-v-e23d9750="" class="row">
                                    <div data-v-e23d9750="" class="col-66"><h1 data-v-e23d9750="" class="fancy-title tu mb5" style="background: {{$color}};color:{{$font_color}}">{{__('SALES ORDER')}}</h1></div>
                                ...
                                <div data-v-e23d9750="" class="">
                                    <div data-v-e23d9750="" class="">
                                        <table data-v-e23d9750="" class="summary-table" style="position: relative;
    padding: 20px 0 !important; display: block;">
                                            <tbody data-v-e23d9750="">
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Number')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::salesorderNumberFormat($settings,$salesorder->invoice)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::dateFormat($settings,$salesorder->issue_date)}}</td>
                                            </tr>
                                            <tr class="ml-8 ">
                                                <td class="">
                                                     <p>{!! DNS2D::getBarcodeHTML(route('pay.salesorder',\Illuminate\Support\Facades\Crypt::encrypt($salesorder->id)), "QRCODE",2,2) !!}</p>
                                                </td>
                                ...
                                <div data-v-363339a0="" class="d-table">
                                    <div data-v-363339a0="" class="d-table">
                                        ...
                                        <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                            ...
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{$salesorder->totalQuantity}}</pre>
                                            </div>
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{\App\Models\Utility::priceFormat($settings,$salesorder->totalRate)}}</pre>
                                            </div>
                                            <div class="d-table-td w-6">
                                                <pre data-v-f2a183a6="">{{\App\Models\Utility::priceFormat($settings,$salesorder->totalTaxPrice) }}</pre>
                                            </div>
                                            @if($salesorder->discount_apply==1)
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">{{\App\Models\Utility::priceFormat($settings,$salesorder->totalDiscount)}}</pre>
                                                </div>
                                            @else
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">-</pre>
                                            ...
                                            <div class="d-table-td w-4 text-right">
                                                    <span>{{\App\Models\Utility::priceFormat($settings,$salesorder->getSubTotal())}}
                                                    </span>
                                            </div>
                                        </div>
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                @if($salesorder->discount_apply==1)
                                                    @if($salesorder->getTotalDiscount())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            ...
                                                            <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,$salesorder->getTotalDiscount())}}</div>
                                                        </div>
                                                    @endif
                                                @endif
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,$salesorder->getSubTotal()-$salesorder->getTotalDiscount()+$salesorder->getTotalTax())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
