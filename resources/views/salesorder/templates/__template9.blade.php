                        ...
                        <div data-v-7d9d14b5="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-2"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('SALES ORDER')}}</h1>
                                        <h3 data-v-7d9d14b5="">{{\App\Models\Utility::salesorderNumberFormat($settings,$salesorder->invoice)}}</h3>
                                        <p data-v-7d9d14b5="">{{\App\Models\Utility::dateFormat($settings,$salesorder->issue_date)}}</p>
                                        <div class="ml-8 mt-5">
