                        ...
                        <div data-v-363339a0="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-2"><h1 data-v-363339a0="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('SALES ORDER')}}</h1>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div data-v-363339a0="" class="col-1 text-right">
                                        <div data-v-363339a0="" class="">
                                            <table data-v-363339a0="" class="summary-table" style="position: relative;">
                                                <tbody data-v-363339a0="" >
                                                <tr data-v-363339a0="">
                                                    <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Number')}}:</td>
                                                    <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::salesorderNumberFormat($settings,$salesorder->Iinvoice)}}</td>
                                                </tr>
                                                <tr data-v-363339a0="">
                                ...
                                <div data-v-363339a0="" class="break-150"></div>
                                <div class="row">
                                    <div class="bill_to">
