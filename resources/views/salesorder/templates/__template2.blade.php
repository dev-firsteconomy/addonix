                        ...
                        <div data-v-37eeda86="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-37eeda86="" class="d-inner">
                                ...
                                <div data-v-37eeda86="" class="">
                                    <strong data-v-37eeda86="" class="tu mb5" style="color: {{$color}};">{{__('SALES ORDER')}}</strong>
                                    <table data-v-37eeda86="" class="summary-table" style="position: relative">
                                        ...
                                        <tr data-v-363339a0="">
                                            ...
                                            <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::dateFormat($settings,$salesorder->due_date)}}</td>
                                        </tr>
                                        <tr class="ml-8 ">
                                            <td class="">
