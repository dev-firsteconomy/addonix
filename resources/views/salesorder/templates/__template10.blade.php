                        ...
                        <div data-v-b8f60a0c="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-33"><h1 data-v-b8f60a0c="" class="fancy-title tu mb5" style="color: {{$color}}; border-top: 15px solid {{$color}};">{{__('SALES ORDER')}}</h1></div>
                                    ...
                                    <div data-v-b8f60a0c="" class="">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::invoiceNumberFormat($settings,$salesorder->invoice)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
