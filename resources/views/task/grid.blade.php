...
@section('action-btn')
    ...
    @can('Create Task')
            <a href="#" data-size="lg" data-url="{{ route('task.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip"
    ...
    <div class="row">
                            ...
                            <div class="btn-group card-option">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    @if (Gate::check('Show Task') || Gate::check('Edit Task') || Gate::check('Delete Task'))
                                        ...
                                        @endcan
                                        @can('Show Task')
                                            <a href="#" data-url="{{ route('task.show', $task->id) }}" data-ajax-popup="true"
                                                class="dropdown-item" data-bs-whatever="{{ __('Task Details') }}"
                                                data-bs-toggle="tooltip" data-title="{{ __('Task Details') }}"><i
                                                    class="ti ti-eye"></i>
                                                {{ __('Details') }}</a>
                                        @endcan
        ...
        <div class="col-md-3">
            ...
            <a href="#" class="btn-addnew-project" data-ajax-popup="true" data-size="lg"
                data-title="{{ __('Create New Task') }}" data-url="{{ route('task.create') }}">
