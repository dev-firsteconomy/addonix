    ...
    <div class="col-lg-12">
            ...
            <div class="">
                <dl class="row">
                    ...
                    <dd class="col-md-7"><span class="text-md">{{ $task->name }}</span></dd>
                    ...
                    <dd class="col-md-7"><span class="text-md">{{\Auth::user()->dateFormat($task->start_date)}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Due Date')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{\Auth::user()->dateFormat($task->due_date  )}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Assigned')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ $task->parent }}</span></dd>
                    ...
                    <dd class="col-md-7"><span class="text-md">{{ $task->description }}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Assigned User')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{ !empty($task->assign_user)?$task->assign_user->name:''}}</span></dd>

                    <dt class="col-md-5"><span class="h6 text-md mb-0">{{__('Created')}}</span></dt>
                    <dd class="col-md-7"><span class="text-md">{{\Auth::user()->dateFormat($task->created_at)}}</span></dd>
