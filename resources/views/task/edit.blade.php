...
@section('action-btn')
    <div class="btn-group" role="group">
        ...
        <div class="action-btn  ms-2">
            <a href="{{ route('task.edit',$previous) }}" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="tooltip" title="{{__('Previous')}}">
        ...
        @if(!empty($next))
        <div class="action-btn  ms-2">
            <a href="{{ route('task.edit',$next) }}" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="tooltip" title="{{__('Next')}}">
                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    {!!Form::select('stage', $stage, null,array('class' => 'form-control','required'=>'required')) !!}
                                    @error('stage')
                                ...
                                <div class="col-6">
                                    ...
                                    {!!Form::date('start_date', date('Y-m-d'),array('class' => 'form-control datepicker','required'=>'required')) !!}
                                    @error('start_date')
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {!!Form::date('due_date', date('Y-m-d'),array('class' => 'form-control datepicker','required'=>'required')) !!}
                                        @error('due_date')
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('user', $user, $task->user_id,array('class' => 'form-control')) !!}
                                        @error('user')
