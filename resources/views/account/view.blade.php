<div class="row">
    <div class="col-lg-12">
            ...
            <div class="">
                ...
                <dl class="row">
                    ...
                    <dd class="col-sm-8"><span class="text-sm">{{ !empty($account->assign_user)?$account->assign_user->name:'-'}}</span></dd>
    ...
    <div class="w-100 text-end pr-2">
        ...
        <div class="action-btn bg-info ms-2">
            <a href="{{ route('account.edit',$account->id) }}" data-bs-toggle="tooltip"class="mx-3 btn btn-sm d-inline-flex align-items-center text-white " data-title="{{__('Account Edit')}}" title="{{__('Edit')}}"><i class="ti ti-edit"></i>
            </a>
        </div>
        @endcan
    </div>
