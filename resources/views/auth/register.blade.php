                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        @endif
                            ...
                            <p class="my-4 text-center">{{ __('Already have an account?') }} <a href="{{ route('login') }}" class="my-4 text-center text-primary"> {{ __('Login') }}</a></p>

                            {{-- <div class="card-footer px-md-5"><small>Already have an account?</small>
                                <a href="{{ route('login') }}" class="small font-weight-bold">{{ __('Signin') }}</a>
                            </div> --}}
