                                            ...
                                            @if (\Auth::user()->type == 'owner' && \Auth::user()->type != 'Accountant' && \Auth::user()->type != 'Manager')
                                                @if ($contract->status == 'accept')
                                                    @can('copy contract')
                                                        ...
                                                        {{-- <div class="action-btn btn-secondary ms-2">
                                                                <a href="#" data-size="lg" data-url="{{ route('contracts.copy.store',[$contract->id]) }}" data-ajax-popup="true" data-title="{{__('Copy Contract')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Copy Contract')}}" ><i class="ti ti-file-text text-white"></i></a>
                                                            </div> --}}
                                                    @endcan
                                                @endif
                                            @endif
